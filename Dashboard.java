...
public class Dashboard extends JFrame{
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel AirlineManagementSystem = new JLabel("Welcome to Taj");
	AirlineManagementSystem.setForeground(Color.BLACK);
        AirlineManagementSystem.setFont(new Font("Georgia", Font.PLAIN, 54));
	AirlineManagementSystem.setBounds(350, 60, 1000, 85);
	NewLabel.add(AirlineManagementSystem);

        JLabel AirlineManagementSystems = new JLabel("Experience Luxury and Comfort at its finest");
	AirlineManagementSystems.setForeground(Color.white);
        AirlineManagementSystems.setFont(new Font("Georgia", Font.PLAIN, 35));
	AirlineManagementSystems.setBounds(350, 150, 1000, 85);
	NewLabel.add(AirlineManagementSystems);
